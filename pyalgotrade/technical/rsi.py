...
class RSI(technical.EventBasedFilter):
    """相对强弱指数指标（RSI）的定义： http://stockcharts.com/school/doku.php?id=chart_school:technical_indicators:relative_strength_index_rsi.

    :param dataSeries: 需要被计算指标的dataSeries.
    :type dataSeries: :class:`pyalgotrade.dataseries.DataSeries`.
    :param period: 周期. 提示：如果周期为 **n** ，则  **n+1**  的值将被使用。因此必须大于1.
    :type period: int.
